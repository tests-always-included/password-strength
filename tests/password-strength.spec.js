...
(function () {
    ...
    PasswordStrength = require("../lib/password-strength.js");
    ...
    describe("addCommonPasswords()", function () {
        ...
        it("tries to add another type of format", function () {
            ...
            expect(function () {
                passwordStrength.addCommonPasswords({abc123: true, "123456": false});
            }).toThrow("Format does not match any expected format.");
        });
    });
